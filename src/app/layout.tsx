"use client"; // 👈 NECESARIO para usar useState y el componente Link

import { useState } from "react"; // 👈 Importamos useState para el menú
import type { Metadata } from "next";
import { Inter, Roboto } from "next/font/google";
import Image from "next/image";
import Link from "next/link"; // 👈 Importamos Link para la navegación en el menú
import "./globals.css";
...
// NOTA: metadata debe estar fuera del componente de cliente, o definida como un objeto simple
// Si esto causa error, mueve la exportación de metadata a otro archivo o úsala directamente.
// Por simplicidad, la dejaremos aquí asumiendo que el compilador de Next.js lo maneja.
